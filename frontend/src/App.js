      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<Baselayout />}>
            ...
            <Route path="madrasah" element={<ProtectedRoute allowedSlug="madrasah" element={<Madrasah />} />} ></Route>
            <Route path="facilities" element={<ProtectedRoute allowedSlug="facilities" element={<Facilities />} />} ></Route>
            <Route path="hajjmanagement" element={<ProtectedRoute allowedSlug="hajjmanagement" element={<HajjManagement />} />} ></Route>
